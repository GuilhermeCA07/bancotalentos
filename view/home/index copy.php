    ...
    <header class="home-header">
        ...
        <div>
            ...
            <a
                href="#"
                class="btn-admin"
                onclick="abrirModalCurriculoLivre()">
...
<script>
    ...
    */
    ...
    async function verificarCurriculo(cpf) {
        const resposta =
            await fetch(
                `?c=home&m=verificarCurriculo&cpf=${cpf}`
            );
        ...
        if (
            ...
            info.innerHTML =
                'Já existe um currículo cadastrado em nosso banco de talentos. Anexe um novo arquivo apenas se desejar substituí-lo.';
        }
    }
    ...
    function salvarDadosCandidato() {
        ...
        const whatsapp =
            document.querySelector('[name="whatsapp"]')?.checked || false;
    ...
    function preencherDadosCandidato() {
        ...
        document
            .querySelectorAll('[name="whatsapp"]')
            .forEach(
                campo => {
